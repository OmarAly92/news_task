...
/// [barrierColor] overrides the scrim laid over the content behind the sheet.
Future<T?> showExpressiveSheet<T>({
  required BuildContext context,
  required WidgetBuilder builder,
  Color barrierColor = kExpressiveSheetBarrierColor,
}) {
...
/// The scrim an expressive sheet lays over the content behind it when no
/// [showExpressiveSheet.barrierColor] is given.
const Color kExpressiveSheetBarrierColor = Colors.black54;
...
class ExpressiveSheetRoute<T> extends PopupRoute<T> {
  ...
  ExpressiveSheetRoute({
    ...
    this.barrierColor = kExpressiveSheetBarrierColor,
    this.barrierLabel,

...
class ExpressiveRefreshIndicatorState extends State<ExpressiveRefreshIndicator>
  ...
  // Built eagerly in initState: a lazy `late final` would run its initializer
  // for the first time inside dispose() when the indicator was never pulled,
  // and creating a Ticker there looks up TickerMode on a deactivated element.
  ...
  void initState() {
    super.initState();
    _fraction = BoundedSingleMotionController(
